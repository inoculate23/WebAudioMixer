...
function setupUI(canvasElement) {
    ...
    toggleGradient.onclick = e => {
        ...
        if (drawParams.showGradient) { drawParams.showGradient = false; } else { drawParams.showGradient = true; }
    }
    ...
    toggleBars.onclick = e => {
        // Toggle underlying parameter value
        if (drawParams.showBars) { drawParams.showBars = false; } else { drawParams.showBars = true; }
    }
    ...
    toggleCircles.onclick = e => {
        // Toggle underlying parameter value
        if (drawParams.showCircles) { drawParams.showCircles = false; } else { drawParams.showCircles = true; }
    }
    ...
    toggleNoise.onclick = e => {
        // Toggle underlying parameter value
        if (drawParams.showNoise) { drawParams.showNoise = false; } else { drawParams.showNoise = true; }
    }
    ...
    toggleInvert.onclick = e => {
        // Toggle underlying parameter value
        if (drawParams.showInvert) { drawParams.showInvert = false; } else { drawParams.showInvert = true; }
    }
    ...
    toggleEmboss.onclick = e => {
        // Toggle underlying parameter value
        if (drawParams.showEmboss) { drawParams.showEmboss = false; } else { drawParams.showEmboss = true; }
    }
